...
describe("<LinkWrapper />", () => {
    ...
    it("all props should render correctly",  () => {
        //expectations
        expect(wrapper.container.querySelector(".link-wrapper__link").innerHTML).toBe("https://www.trendyol.com/mudo-concept/mermer-dokulu-kavanoz-tea-900-cc-p-4224144");
